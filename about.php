                    ...
                    <article class="col-md-8">
                      ...
                      <div class="row">
                          <div class="col-md-3 col-sm-4 col-xs-4 text-center">
                              <img src="img/jackbio.jpg" alt="" class="img-thumbnail">
                              <h3 class="title">Jack Sullivan</h3>
                              <small>Owner / CEO</small>
                          </div>
                          <div class="col-md-3 col-sm-4 col-xs-4 text-center">
                              <img src="img/tonybio.jpg" alt="" class="img-thumbnail">
                              <h3 class="title">Tony Bevacqua</h3>
